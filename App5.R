...
ui <- fluidPage(theme = shinytheme("darkly"),
                navbarPage("BMI Calculator:",
                           ...
                           tabPanel("Navbar 2", 
                                    ...
                                    sidebarPanel(
                                      tags$h3("Noms:"),
                                      textInput("text1", "Nom:", " "), # txt1 will be send to the server
                                      textInput("text2", "Prenom:", " "), # txt2 will be send to the server
                                      textInput("text3", "Age")
                                      ...
                                      h4("Sortie 1"),
                                      verbatimTextOutput("sortie"), # txtout genereted from the server
